...
scores_df = pd.read_csv("data/scores_gpt_oss.csv", encoding="utf-8", encoding_errors="replace")
...
print("=== GPT-OSS-20B OVERALL SCORECARD ===")
...
category_summary.to_csv("data/scorecard_summary_gpt_oss.csv")
print("\nDone!")