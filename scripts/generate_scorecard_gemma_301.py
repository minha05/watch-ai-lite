...
scores_df = pd.read_csv("data/scores_gemma_301.csv", encoding="utf-8", encoding_errors="replace")
...
print("=== GEMMA OVERALL SCORECARD (301-question set, LLM-Judged) ===")
...
category_summary.to_csv("data/scorecard_summary_gemma_301.csv")
print("\nDone! Saved to data/scorecard_summary_gemma_301.csv")
