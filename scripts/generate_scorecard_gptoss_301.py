...
scores_df = pd.read_csv("data/scores_gptoss_301.csv", encoding="utf-8", encoding_errors="replace")
...
print("=== GPT-OSS-20B OVERALL SCORECARD (301-question set, LLM-Judged) ===")
...
category_summary.to_csv("data/scorecard_summary_gptoss_301.csv")
print("\nDone! Saved to data/scorecard_summary_gptoss_301.csv")
