...
summary = pd.read_csv("data/scorecard_summary_gemma_301.csv")
#draws barcharts
...
plt.title("Gemma (301-question set): Average Score by Category")
...
#safe as png
plt.tight_layout()
plt.savefig("data/chart_gemma_301_categories.png", dpi=150)
print("Done! Chart saved to data/chart_gemma_301_categories.png")
